...
class BookingPage extends Component {
  ...
  jsPdfGenerator = () => {
    ...
    doc.setFontSize(35);
    doc.text(`Cinema +`, 20, 25);
    doc.setFontType('semi-bold');
    doc.setFontSize(23);
    doc.text(`Checkout-By: Alula Mekonen`, 20, 40);
    doc.setFontSize(20);
    doc.text(`Movie-Name: ${movie.title}`, 20, 50);
    doc.setFontType('normal');
    doc.setFontSize(16);
    doc.text(`Cinema-Name: ${cinema.name}`, 20, 70);
    doc.text(
      `Date: ${new Date(
        selectedDate
    ...
    doc.addImage(QRCode, 'JPEG', 55, 95, 100, 100);
